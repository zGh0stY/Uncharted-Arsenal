...
public class FireGeyserParticle extends TextureSheetParticle {
    ...
    protected FireGeyserParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteset, double dX, double dY, double dZ) {
    ...
    public void tick() {
        ...
        if (age++ > lifetime) {
            this.remove();
            this.level.addParticle(UAParticles.FIRE_GEYSER_END.get(), this.x, this.y, this.z, 0.0D, 0.0D, 0.0D);
        }
        else {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new FireGeyserParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
